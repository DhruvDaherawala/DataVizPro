/**
 * Data analysis utility to detect patterns and correlations in datasets
 */
 ...
 */
const determineColumnTypes = (data, columns) => {
  const columnTypes = {};
 ...
 */
const calculateStatistics = (data, columnTypes) => {
  const stats = {};
 ...
 */
const detectCorrelations = (data, columnTypes) => {
  const correlations = [];
 ...
 */
const recommendCharts = (columnTypes, stats, correlations) => {
...
const analyzeData = (data, columns) => {
  ...
  const columnTypes = determineColumnTypes(data, columns);
  
  // Calculate statistics for numeric columns
  const statistics = calculateStatistics(data, columnTypes);
  
  // Detect correlations between numeric columns
  const correlations = detectCorrelations(data, columnTypes);
  
  // Get chart recommendations
  const chartRecommendations = recommendCharts(columnTypes, statistics, correlations);
